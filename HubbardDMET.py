...
class HubbardDMET:
    ...
    def Solve( self ):
        ...
        while ( normOfDiff >= threshold ): 
            ...
            embedding1RDM = DMETorbitals.ConstructEmbedding1RDM( impurityOrbs, solutionRHF, self.Nelectrons/2 )
            dmetOrbs = DMETorbitals.ConstructBathOrbitals( impurityOrbs, embedding1RDM, numBathOrbs )
